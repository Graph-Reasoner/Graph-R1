...
def default_compute_score(
    ...
    if data_source == "openai/gsm8k":
        ...
        # from . import test
        # from . import grapharena
        # res = grapharena.compute_score(solution_str, ground_truth, extra_info, task_name=data_source)
        ...
        # from . import grapharena_norepeat
        # res = grapharena_norepeat.compute_score(solution_str, ground_truth, extra_info, task_name=data_source)
